...
const GACHA_DATABASE = {
  ...
  "big_golden_mirage_house": {
    ...
    items: {
      rare: [
        { name: "Gold Sand Draped Lounge Couch",       tag: "🌈", c: 0.0026875 },
        { name: "Gold Sand Lattice Alcove Couch",      tag: "🌈", c: 0.0026875 },
        { name: "Gold Sand Silk Canopy Spice Boat",    tag: "🌈", c: 0.0026875 },
        { name: "Gold Sand Brocade Loom",              tag: "🌈", c: 0.0026875 },
        { name: "Oasis Lattice Square Pool",           tag: "🌈", c: 0.0026875 },
        { name: "Oasis Arched Flower Walkway",         tag: "🌈", c: 0.0026875 },
        { name: "Oasis Lattice Quartered Pool",        tag: "🌈", c: 0.0026875 },
        { name: "Gold Sand Tower Archway",             tag: "🌈", c: 0.0026875 },
        { name: "Gold Sand Canopy Pendant Lamp",       tag: "🥇", c: 0.0026875 },
        { name: "Oasis Coffee Tent",                   tag: "🥇", c: 0.0026875 },
        { name: "Gold Sand Instrument Stall",          tag: "🥇", c: 0.0026875 },
        { name: "Gold Sand Large Fountain",            tag: "🥇", c: 0.0026875 },
        { name: "Desert Fan Palm",                     tag: "🥇", c: 0.0026875 },
        { name: "Gold Sand Argyle Dome",               tag: "🥇", c: 0.0026875 },
        { name: "Gold Sand Draped Bay Window",         tag: "🥇", c: 0.0026875 },
        { name: "Gold Sand Silk Screen Wall",          tag: "🥇", c: 0.0026875 } 
      ],
      common: [
